...
namespace SMSHazard.Web.Models.PublicReport;

/// <summary>Public (unauthenticated) hazard submission form.</summary>
public class PublicReportViewModel
{
    ...
    /// <summary>Honeypot: must stay empty. Bots that fill every field are rejected. Not shown to humans.</summary>
...
/// <summary>Public status lookup by tracking code.</summary>
public class TrackViewModel
{
    ...
    public SMSHazard.Application.DTOs.PublicTrackDto? Result { get; set; }

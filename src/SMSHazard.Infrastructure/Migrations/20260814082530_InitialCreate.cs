        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ReferenceNo = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    HazardCategoryId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HazardReports_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HazardReports_HazardCategories_HazardCategoryId",
                        column: x => x.HazardCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    HazardReportId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_HazardReports_HazardReportId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    ...
                    EffectivenessNote = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CorrectiveActions_HazardReports_HazardReportId",
                        column: x => x.HazardReportId,
                        principalTable: "HazardReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssessedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    AssessedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsResidual = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RiskAssessments_HazardReports_HazardReportId",
                        column: x => x.HazardReportId,
                        principalTable: "HazardReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_HazardReportId",
                table: "Attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveActions_HazardReportId",
                table: "CorrectiveActions",
                column: "HazardReportId");

            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveActions_Status_DueDate",
                table: "CorrectiveActions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HazardReports_DepartmentId",
                table: "HazardReports",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_HazardReports_HazardCategoryId",
                table: "HazardReports",
                column: "HazardCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HazardReports_ReferenceNo",
                table: "HazardReports",
                column: "ReferenceNo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiskAssessments_HazardReportId",
